...
;
function createClient(admin = false) {
    // for (
    //   const env of [
    ...
    //   }
    // }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://htpiytutvbshtojgbxwy.supabase.co"), admin ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.SUPABASE_SERVICE_ROLE_KEY : ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh0cGl5dHV0dmJzaHRvamdieHd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDE5MDQ1MjUsImV4cCI6MjA1NzQ4MDUyNX0.RzEXSbKOIcEpj0rX58H1vmFHoNdn6C3k1geg5Gfg8Nc"));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
function AuthProvider({ children }) {
    ...
    const fetchGithubProfile = async (userId)=>{
        if (!userId) return;
        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (response.status === 404) {
                    console.log('No GitHub profile found for user - this is normal for new users');
    ...
    const signInWithGitHub = async ()=>{
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || 'Failed to start GitHub authentication');
            }
            const data = await response.json();
...
_s(AuthProvider, "dbapiuDegYMqnK31Z2XaK+u4kIA=");
_c = AuthProvider;
function useAuth() {
    _s1();
    ...
    const toast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useToast.useCallback[toast]": (props)=>{
            ...
            if (props.duration !== 0) {
                ...
                }["useToast.useCallback[toast]"], props.duration || 5000);
            }
            return id;
        }
    }["useToast.useCallback[toast]"], []);
...
const Toast = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: toasts.map((toast)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: `rounded-md shadow-lg p-4 min-w-[300px] max-w-[500px] animate-in slide-in-from-right ${toast.variant === 'destructive' ? 'bg-destructive text-destructive-foreground' : 'bg-background text-foreground'}`,
...
_s(Toast, "PzC7objhBSpx7Fad5FlTs8RRD/Q=", false, function() {
    return [
...
//# sourceMappingURL=src_cb812f44._.js.map