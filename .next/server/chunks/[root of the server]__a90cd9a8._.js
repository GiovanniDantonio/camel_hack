...
"[project]/.next-internal/server/app/api/projects/[id]/repository/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/projects/[id]/repository/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        if (projectError || !projectData) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Project not found" + (projectError ? ": " + projectError.message : "")
            }, {
                status: 404
            });
        }
        ...
        // Fetch branch data
        const branchesResponse = await fetch(`${GITHUB_API_URL}/repos/${repoFullName}/branches`, {
            headers: {
                "Authorization": `Bearer ${githubToken}`,
                "Accept": "application/vnd.github.v3+json"
            }
        ...
        const branchesWithCommits = await Promise.all(branchesData.map(async (branch)=>{
            const commitsResponse = await fetch(`${GITHUB_API_URL}/repos/${repoFullName}/commits?sha=${branch.name}&per_page=100`, {
                headers: {
                    "Authorization": `Bearer ${githubToken}`,
                    "Accept": "application/vnd.github.v3+json"
                }
        ...
        const languagesResponse = await fetch(`${GITHUB_API_URL}/repos/${repoFullName}/languages`, {
            headers: {
                "Authorization": `Bearer ${githubToken}`,
                "Accept": "application/vnd.github.v3+json"
            }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a90cd9a8._.js.map