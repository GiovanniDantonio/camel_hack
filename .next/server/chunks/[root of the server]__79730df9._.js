...
"[project]/.next-internal/server/app/api/github/repositories/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/github/repositories/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data: githubProfile, error: profileError } = await supabase.from("github_profiles").select("*").eq("user_id", user.id).single();
        if (profileError) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(transformedRepos);
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__79730df9._.js.map