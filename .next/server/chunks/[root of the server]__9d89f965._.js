...
"[project]/.next-internal/server/app/api/vulnerabilities/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/vulnerabilities/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: vulnerability, error } = await supabase.from('vulnerabilities').select(`
        id,
        status,
        resolution_note,
        resolved_by,
      ...
      `).eq('id', id).single();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(vulnerability);
    } catch (error) {
...
async function PATCH(request, { params }) {
    try {
        ...
        const { data, error } = await supabase.from('vulnerabilities').update(updateData).eq('id', id).select();
        if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9d89f965._.js.map