...
"[project]/.next-internal/server/app/api/projects/settings/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/projects/settings/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request) {
    try {
        ...
        const { project_name, description, target_url, scan_frequency } = await request.json();
        ...
        const { data: existingProject, error: projectError } = await supabase.from('projects').select('user_id').eq('id', projectId).single();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8a022eeb._.js.map